...
export const en = {
  ...
  imageCardIntro: 'Durable image generation tools for Nano Banana 2 (gemini-3.1-flash-image).',
...
export const zh: Record<AntigravityAuthKey, string> = {
  ...
  imageCardIntro: '面向 Nano Banana 2（gemini-3.1-flash-image）的持久化 generate_image 工具。',
